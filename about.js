...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initializePage();
        // Check video setup
    setTimeout(checkVideoSetup, 1000);
});
const checkVideoSetup = () => {
    console.log('Checking video setup...');
    console.log('Video element:', document.querySelector('video'));
    console.log('Play button:', document.querySelector('.play-button'));
    console.log('Play/Pause button:', document.querySelector('.play-pause-btn'));
    console.log('Progress bar:', document.querySelector('.progress-bar'));
    console.log('Volume button:', document.querySelector('.volume-btn'));
    console.log('Fullscreen button:', document.querySelector('.fullscreen-btn'));
};